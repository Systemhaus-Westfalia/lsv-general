 ...
 */
public abstract class CopySODefinitionsAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ECA25_CopySODefinitions";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy SO Definitions";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54630;
