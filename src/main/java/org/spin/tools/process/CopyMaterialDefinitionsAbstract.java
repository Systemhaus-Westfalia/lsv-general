 ...
 */
public abstract class CopyMaterialDefinitionsAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ECA25_CopyMaterialDefinitions";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy Material Definitions";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54628;
