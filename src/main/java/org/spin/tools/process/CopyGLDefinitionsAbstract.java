 ...
 */
public abstract class CopyGLDefinitionsAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ECA25_CopyGLDefinitions";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy GL Definitions";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54629;
