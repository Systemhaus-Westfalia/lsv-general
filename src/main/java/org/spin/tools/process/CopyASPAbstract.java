...
/** Generated Process for (Copy ASP's)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public abstract class CopyASPAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ECA25_CopyASP";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy ASP's";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54626;
