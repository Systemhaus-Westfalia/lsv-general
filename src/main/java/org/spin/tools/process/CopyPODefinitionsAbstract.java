 ...
 */
public abstract class CopyPODefinitionsAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ECA25_CopyPODefinitions";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy PO Definitions";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54631;
