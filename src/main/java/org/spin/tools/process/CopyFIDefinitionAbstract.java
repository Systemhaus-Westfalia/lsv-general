 ...
 */
public abstract class CopyFIDefinitionAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ECA25_CopyFIDefinition";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy Financial from Client";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54633;
