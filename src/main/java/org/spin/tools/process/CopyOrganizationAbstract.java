 ...
 */
public abstract class CopyOrganizationAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "CopyOrganization";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy Organization";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54541;
