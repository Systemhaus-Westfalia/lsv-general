 ...
 */
public abstract class CopyDocumentTypesAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ECA25_CopyDocumentTypes";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Copy Document Types";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54627;
