...
import org.adempiere.core.domains.models.I_C_AllocationLine;
...
// N
    ...
    {
		return (I_LCO_WithholdingRule)MTable.get(getCtx(), I_LCO_WithholdingRule.Table_Name)
    ...
    {
		return (I_LCO_WithholdingType)MTable.get(getCtx(), I_LCO_WithholdingType.Table_Name)
