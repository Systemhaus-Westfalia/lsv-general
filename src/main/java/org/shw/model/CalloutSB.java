...
public class CalloutSB extends BrowserCallOutEngine {
	...
	{
		GridField gf = (GridField)row.getValueOfColumn(currentRow, "M_Product_ID");
		BigDecimal M_Product_ID = (BigDecimal)gf.getValue();
		Env.setContext(Env.getCtx(),WindowNo, "PF_M_Product_ID", M_Product_ID.intValue());
		return "";
	}
