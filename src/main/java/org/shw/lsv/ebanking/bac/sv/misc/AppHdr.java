...
public class AppHdr {
	...
	public AppHdr(RequestParams params, JsonValidationExceptionCollector collector) {
		try {
	...
	public void setCreDt(String creDt) {
		boolean patternOK = (creDt != null) && Pattern.matches(EBankingConstants.PATTERN_DATETIME_TZ, creDt);
