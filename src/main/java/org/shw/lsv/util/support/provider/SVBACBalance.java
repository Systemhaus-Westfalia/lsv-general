...
public class SVBACBalance implements IDeclarationProvider {
	...
	public String getBalance() throws Exception {
		...
		else if (response.getStatus() ==200 ) 
		{
            ...
            CAMT052ResponseFile camt052ResponseFile=   camt052Response.getcAMT052ResponseFile();
            String amtString =  camt052ResponseFile.getcAMT052ResponseEnvelope().getcAMT052ResponseDocument()
            .getBkToCstmrAcctRpt().getRpt().getBal().getAmt().getAmt();
