 ...
 */
public abstract class EInvoiceGenerateAndPost_VoidedAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "EInvoiceGenerateAndPost_Voided";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "EInvoiceGenerateAndPost_Voided";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 3000427;
