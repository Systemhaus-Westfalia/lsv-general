 ...
 */
public abstract class ei_TestJsonAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "ei_TestJson";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "ei_TestJson";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 1000093;
