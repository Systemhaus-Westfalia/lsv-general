...
//		}
	...
	private JSONObject generateCuerpoDocumentoInputData() {
		...
		for (MInvoiceLine invoiceLine:invoice.getLines()) { 
			...
			int uomValue = isVentanoGravada?  99: uom_getValue(uom);
			jsonCuerpoDocumentoItem.put(FacturaExportacion.UNIMEDIDA, uomValue);
			...
			jsonCuerpoDocumentoItem.put(FacturaExportacion.NOGRAVADO, ventaNoGravada);
