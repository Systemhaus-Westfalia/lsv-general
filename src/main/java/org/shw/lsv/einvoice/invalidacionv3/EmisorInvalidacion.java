 ...
 */
public class EmisorInvalidacion {
	...
	public void setNit(String nit) {
		...
		if(patternOK)
	        ...
	        throw new IllegalArgumentException("Wrong expression 'nit' (" + nit +  ") in Anulacion.Emisor.setNit()" + "\n");
	}
	...
	public void setNombre(String nombre) {
		...
		if(length>=MINLENGTH && length<=MAXLENGTH)
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'nombre' (" + nombre +  ") in Anulacion.Emisor.setNombre()" + "\n");
	}
	...
	public void setTipoEstablecimiento(String tipoEstablecimiento) {
		if (tipoEstablecimiento.compareTo("01")==0 || tipoEstablecimiento.compareTo("02")==0 || tipoEstablecimiento.compareTo("04")==0 || tipoEstablecimiento.compareTo("07")==0 || tipoEstablecimiento.compareTo("20")==0)
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'tipoEstablecimiento' (" + tipoEstablecimiento +  ") in Anulacion.Emisor.setTipoEstablecimiento()" + "\n");
	}
	...
	public void setNomEstablecimiento(String nomEstablecimiento) {
		...
		if( (length>=MINLENGTH && length<=MAXLENGTH)  || (nomEstablecimiento==null) )
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'nomEstablecimiento' (" + nomEstablecimiento +  ") in Anulacion.Emisor.setNomEstablecimiento()" + "\n");
	}
	...
	public void setTelefono(String telefono) {
		...
		if(length>=MINLENGTH && length<=MAXLENGTH && patternOK)
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'telefono' (" + telefono +  ") in Anulacion.Emisor.setTelefono()" + "\n");
	}
	...
	public void setCorreo(String correo) {
		...
		if(length>=MINLENGTH && length<=MAXLENGTH)
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'correo' (" + correo +  ") in Anulacion.Emisor.setCorreo()" + "\n");
	}
	...
	public void setCodEstableMH(String codEstableMH) {
		...
		if( (length>=MINLENGTH && length<=MAXLENGTH) || (codEstableMH==null) )
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'codEstableMH' (" + codEstableMH +  ") in Anulacion.Emisor.setCodEstableMH()" + "\n");
	}
	...
	public void setCodEstable(String codEstable) {
		...
		if( (length>=MINLENGTH && length<=MAXLENGTH) || (codEstable==null) )
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'codEstable' (" + codEstable +  ") in Anulacion.Emisor.setCodEstable()" + "\n");
	}
	...
	public void setCodPuntoVentaMH(String codPuntoVentaMH) {
		...
		if( (length>=MINLENGTH && length<=MAXLENGTH) || (codPuntoVentaMH==null) )
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'codPuntoVentaMH' (" + codPuntoVentaMH +  ") in Anulacion.Emisor.setCodPuntoVentaMH()" + "\n");
	}
	...
	public void setCodPuntoVenta(String codPuntoVenta) {
		...
		if( (length>=MINLENGTH && length<=MAXLENGTH) || (codPuntoVenta==null) )
	        ...
	        throw new IllegalArgumentException("Wrong parameter 'codPuntoVenta' (" + codPuntoVenta +  ") in Anulacion.Emisor.setCodPuntoVenta()" + "\n");
	}
