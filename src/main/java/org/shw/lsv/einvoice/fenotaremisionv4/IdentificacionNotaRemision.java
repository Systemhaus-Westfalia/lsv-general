...
public class IdentificacionNotaRemision {

	static final int VERSION              = 4;
	static final String TIPO_DE_DOCUMENTO = "04";
	...
	static final String VALIDATION_TIPOCONTINGENCIA_NOT_NULL   = "Documento: Credito Fiscal, clase: Identificacion. Validacion fall??: valor de 'tipoContingencia' debe ser ='null'";
	static final String VALIDATION_MOTIVOCONTINGENCIA_NOT_NULL = "Documento: Credito Fiscal, clase: Identificacion. Validacion fall??: valor de 'motivoContingencia' debe ser ='null'";
	static final String VALIDATION_TIPOMODELO_FAILED_2         = "Documento: Credito Fiscal, clase: Identificacion. Validacion fall??: valor de 'tipoModelo' no debe ser diferente a 2";
	 ...
	 * No parameters
	 */
	public IdentificacionNotaRemision() {
	...
	public void setNumeroControl(String numeroControl) {
		final String PATTERN = "^DTE-04-(M|B|S|P)([0-9]{3})(P)([0-9]{3})-[0-9]{15}";
