...
public class DocumentoRelacionadoItemNotaRemision {
	...
	/**
	 */
	public DocumentoRelacionadoItemNotaRemision() {
	}
	 ...
	 * @param fechaEmision
	 */
	public DocumentoRelacionadoItemNotaRemision(String tipoDocumento, int tipoGeneracion, String numeroDocumento,
			String fechaEmision) {
