 ...
 * 
 */
public class CuerpoDocumentoItemNotaRemision {
	 ...
	 */
	public CuerpoDocumentoItemNotaRemision() {
	 ...
	 * @param noGravado
	 */
	public CuerpoDocumentoItemNotaRemision(int numItem, int tipoItem, String numeroDocumento, BigDecimal cantidad, String codigo,
