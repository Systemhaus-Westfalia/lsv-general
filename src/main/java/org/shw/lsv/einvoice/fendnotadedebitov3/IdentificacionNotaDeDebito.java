...
public class IdentificacionNotaDeDebito {
	...
	static final String VALIDATION_TIPOMODELO_FAILED_1         = "Documento: Nota de Debito, clase: Identificacion. Validacion fallo: valor de 'tipoModelo' no debe ser diferente a 1";
	static final String VALIDATION_TIPOCONTINGENCIA_NOT_NULL   = "Documento: Nota de Debito, clase: Identificacion. Validacion fallo: valor de 'tipoContingencia' debe ser ='null'";
	static final String VALIDATION_MOTIVOCONTINGENCIA_NOT_NULL = "Documento: Nota de Debito, clase: Identificacion. Validacion fallo: valor de 'motivoContingencia' debe ser ='null'";
	static final String VALIDATION_TIPOMODELO_FAILED_2         = "Documento: Nota de Debito, clase: Identificacion. Validacion fallo: valor de 'tipoModelo' no debe ser diferente a 2";
	static final String VALIDATION_TIPOOCONTINGENCIA_IS_NULL   = "Documento: Nota de Debito, clase: Identificacion. Validacion fallo: valor de 'tipoContingencia' no debe ser ='null'";
	static final String VALIDATION_MOTIVOCONTINGENCIA_IS_NULL  = "Documento: Nota de Debito, clase: Identificacion. Validacion fallo: valor de 'motivoContingencia' no debe ser ='null'";
