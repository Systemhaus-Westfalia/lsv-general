...
public class IdentificacionFactura {
	...
	public void setAmbiente(String ambiente) {
		if (ambiente.compareTo("00") == 0 || ambiente.compareTo("01") == 0)
			...
			throw new IllegalArgumentException(
					"Wrong parameter 'ambiente' in Factura.Identificacion.setAmbiente()" + "\n");
	}
	...
	public void setNumeroControl(String numeroControl) {
		...
		if (patternOK)
			...
			throw new IllegalArgumentException(
					"Wrong expression 'numeroControl' in Factura.Identificacion.setNumeroControl()" + "\n");
	}
	...
	public void setTipoContingencia(Integer tipoContingencia) {
		if (tipoContingencia == null || tipoContingencia == 1 || tipoContingencia == 2 || tipoContingencia == 3
				|| tipoContingencia == 4 || tipoContingencia == 5)
			this.tipoContingencia = tipoContingencia;
		else
			throw new IllegalArgumentException(
					"Wrong parameter 'tipoContingencia' in Factura.Identificacion.setTipoContingencia()" + "\n");
	...
	public void setCodigoGeneracion(String codigoGeneracion) {
		...
		if (patternOK)
			...
			throw new IllegalArgumentException(
					"Wrong expression 'codigoGeneracion' in Factura.Identificacion.setCodigoGeneracion()" + "\n");
	}
	...
	public void setMotivoContin(String motivoContin) {
		...
		if ((length >= MINLENGTH && length <= MAXLENGTH) || (motivoContin == null))
			...
			throw new IllegalArgumentException(
					"Wrong parameter 'motivoContin' in Factura.Identificacion.setMotivoContin()" + "\n");
	}
	...
	public void setHorEmi(String horEmi) {
		...
		if (patternOK)
			...
			throw new IllegalArgumentException(
					"Wrong expression 'horEmi' in Factura.Identificacion.setHorEmi()" + "\n");
	}
	...
	public void setTipoModelo(int tipoModelo) {
		if (tipoModelo == 1 || tipoModelo == 2)
			...
			throw new IllegalArgumentException(
					"Wrong parameter 'tipoModelo' in Factura.Identificacion.setTipoModelo()" + "\n");
	}
	...
	public void setTipoOperacion(int tipoOperacion) {
		if (tipoOperacion == 1 || tipoOperacion == 2)
			...
			throw new IllegalArgumentException(
					"Wrong parameter 'tipoOperacion' in Factura.Identificacion.setTipoOperacion()" + "\n");
	}
