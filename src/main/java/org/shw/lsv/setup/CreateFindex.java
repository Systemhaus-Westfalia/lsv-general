...
/**
 * Create a Setup for Findex provider and all registration, please add `token` parameter
 * @author Yamel Senih, ysenih@erpya.com, ERPCyA http://www.erpya.com
 */
public class CreateFindex implements ISetupDefinition {
	...
	private void createRegistration(Properties context, String transactionName) {
		...
		//	Get
		MADAppSupport applicationSupport = new Query(context, MADAppSupport.Table_Name, "Classname = ? AND ApplicationType = ?", transactionName).setParameters(Findex.class.getName(), APPLICATION_TYPE).first();
		//	
		...
		registration.setValue("Findex-Connection");
