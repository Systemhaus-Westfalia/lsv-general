 ...
 */
public final class SHW_EMail implements Serializable
{
	 ...
	 * @param message
	 */
	public SHW_EMail (MClient client, String from, String to, 
	 ...
	 */
	public SHW_EMail (MClient client, int eMailConfigId, String from, String to, 
	 ...
	 */
	@Deprecated
	public SHW_EMail(String smtpHost, String from, String to, 
			String subject, String message, boolean html) {
	 ...
	 */
	@Deprecated
	public SHW_EMail(String smtpHost, int smtpPort, String protocol, String encryptionType, String authMechanism, String from, String to, 
			String subject, String message, boolean html) {
	 ...
	 */
	@Deprecated
	public SHW_EMail(String smtpHost, int smtpPort, String protocol, String encryptionType, String authMechanism) {
	 ...
	 * @param eMailConfigId
	 */
	public SHW_EMail (MClient client, int eMailConfigId) {
		//	FR [ 402 ]
	 ...
	 * @param client
	 */
	public SHW_EMail (MClient client) {
	...
	/**	Logger							*/
	protected static CLogger		log = CLogger.getCLogger (SHW_EMail.class);
	...
	public static void main (String[] args)
	{
		...
		//	FR [ 402 ]
		SHW_EMail email = new SHW_EMail(args[0], args[1], args[2], args[3], args[4], false);
		email.send();
	}   //  main
	...
	public static String validateMailDelivery(Properties ctx, String requestEMail, String requestPassword, int eMailConfigId, String name) {
		...
		//
		SHW_EMail email = new SHW_EMail(MClient.get(ctx), eMailConfigId, requestEMail, requestEMail,
		...
		try
		{
			...
			if (SHW_EMail.SENT_OK.equals (returnMessage))
			{
