...
/** Generated Process for (groovy:AguinaldosDias AguinaldosDias)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public class groovy_AguinaldosDias implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		Double diascalculatorios = process.getList("Aguinaldo", diastrabajados.doubleValue(), "1");
		result = diascalculatorios;
		return result;
	}
