...
/** Generated Process for (groovy:R_HEXTR_Normal Horas Extras Normal)
 *  Description: Normale Ueberstunden
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public class groovy_R_HEXTR_Normal implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		double c_he_o = process.getConcept("O_HorasExtras_D");
