...
/** Generated Process for (groovy:R_HEXTR_DFA Horas Extras Domingo)
 *  Description: Uebersunden, Sonn-Feiertag
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public class groovy_R_HEXTR_DFA implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		double c_he_o = process.getConcept("O_HorasExtras_DDF");
		...
		//Faktor
		double faktor = process.getConcept("P_HEXT_D_D");
