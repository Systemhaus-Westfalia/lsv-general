 ...
 */
public abstract class SHW_C_BankStatementBankTransferAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SHW_C_BankStatementBankTransfer";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Bank Transfer";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54968;
