 ...
 */
public class SHW_EMailTest extends SvrProcess
{
	/** Client Parameter			*/
	...
	protected String doIt () throws Exception
	{
		...
		String result = "";
		result = SHW_EMail.validateMailDelivery(getCtx(), client.getRequestEMail(), client.getRequestUserPW(), client.getAD_EMailConfig_ID(), getName());

		addLog(0, null, null, client.getName() + ": " + client);
