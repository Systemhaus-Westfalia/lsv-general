...
public abstract class SBProcess_ProjectIssueFromInventoryAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBProcess_ProjectIssueFromInventory";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "SBProcess_ProjectIssueFromInventory";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54195;
