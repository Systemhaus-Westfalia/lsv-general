 ...
 */
public abstract class UpdateProjectCostAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "UpdateProjectCost";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "UpdateProjectCost";
	/** Process Id 	*/
