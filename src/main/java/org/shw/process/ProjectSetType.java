...
public class ProjectSetType extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		if (project.getC_BPartner_ID()== 0)
			return "Falta el socio de negocio";

		if (project.get_ValueAsInt(MLGRoute.COLUMNNAME_LG_Route_ID) == 0  && type.getProjectCategory().equals("M"))
			return "Falta definir la ruta";
		if (type.getC_ProjectType_ID() == 0 
				&& (type.getC_ProjectType_ID() != m_C_ProjectType_ID || type.getProjectCategory().equals("T")))
