 ...
 */
public abstract class SBProcess_ProjetIssueTimeExpenseAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBProcess_ProjetIssueTimeExpense";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "SBProcess_ProjetIssueTimeExpense";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 1000026;
