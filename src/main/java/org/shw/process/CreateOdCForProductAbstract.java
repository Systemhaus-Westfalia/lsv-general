 ...
 */
public abstract class CreateOdCForProductAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "CreateOdCForProduct";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "CreateOdCForProduct";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 3000368;
